...
const DME1 = () => {
  ...
  style={{
    ...
    borderBottom: selectedIndex === 1 ? "4px solid white" : "none",
...
<Text
  style={{
    ...
    borderBottom: selectedIndex === 2 ? "4px solid white" : "none",
...
<Text
  style={{
    ...
    borderBottom: selectedIndex === 3 ? "4px solid white" : "none",
...
<Text
  style={{
    ...
    borderBottom: selectedIndex === 4 ? "4px solid white" : "none",
